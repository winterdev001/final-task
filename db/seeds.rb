...
1.upto(12) do |num|                                                   
    Job.create!(title: "Software Developer", deadline: "2019-12-#{num} 1:40:00",  amount: "2#{num}", job_type:"Fulltime", location:"kigali#{num}",remote:"1",description:"web developer",company_id:1)       
end  
